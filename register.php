          ...
          <div class="card text-black" style="border-radius: 25px;">
            <div class="card-body p-md-2">
              <div class="row justify-content-center">
                <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Créer votre compte</p>
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example1c"><i class="bi bi-person-circle"></i> Nom et Prénom</label>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example5c"><i class="bi bi-building"></i> Votre poste</label>
                        <input type="text" id="form3Example5c" class="form-control form-control-lg py-3" name="position" autocomplete="off" placeholder="enter your position" style="border-radius:25px ;" />
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example6c"><i class="bi bi-telephone"></i> Votre téléphone</label>
                        <input type="tel" id="form3Example6c" class="form-control form-control-lg py-3" name="phone" autocomplete="off" placeholder="enter your phone number" style="border-radius:25px ;" />
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example7c"><i class="bi bi-people"></i> Role</label>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="role" id="consultant" value="0">
                          <label class="form-check-label" for="consultant">Consultant</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="role" id="gestion" value="1">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Créer compte" name="register" class="btn btn-warning btn-lg text-light my-2 py-3" style="width:100%; border-radius: 30px; font-weight:600; background-color: blue; border-radius: 25px;" />
                    </div>
